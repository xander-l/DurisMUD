...
/*  SKILL_CREATE("headlock", SKILL_HEADLOCK, TAR_PHYS);
  ...
  SPEC_SKILL(CLASS_ANTIPALADIN, 11, 60);
  SPEC_SKILL_ADD(CLASS_ANTIPALADIN, 30, 100, SPEC_VIOLATOR);
  SPEC_SKILL(CLASS_BARD, 11, 40);
  SPEC_SKILL(CLASS_BERSERKER, 11, 50);  
  SPEC_SKILL_ADD(CLASS_BERSERKER, 30, 100, SPEC_RAGELORD);
  SPEC_SKILL_ADD(CLASS_PALADIN, 30, 80, SPEC_CRUSADER);
  SPEC_SKILL(CLASS_ROGUE, 11, 40);
  SPEC_SKILL(CLASS_WARRIOR, 11, 60);
