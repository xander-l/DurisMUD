...
// 1 Day for under lvl 50, 2 days over + random number of hours up to a day..
#define CAP_DELAY(old_level) (time(NULL) + SECS_PER_REAL_DAY * (old_level / 50 + 1) + SECS_PER_REAL_HOUR * number(1,24))
