...
struct epic_reward {
 ...
 /* {EPIC_REWARD_SKILL, SKILL_CHANT_MASTERY, 100, 1, 500000,
  ...
  {EPIC_REWARD_SKILL, SKILL_SUMMON_BLIZZARD, 500, 50, 1000000,
   CLASS_SHAMAN | CLASS_SORCERER | CLASS_ETHERMANCER |
   CLASS_DRUID},
  {EPIC_REWARD_SKILL, SKILL_SUMMON_FAMILIAR, 100, 75, 500000,
 ...
 /* {EPIC_REWARD_SKILL, SKILL_SNEAKY_STRIKE, 100, 1, 1000000,
  ...
  {EPIC_REWARD_SKILL, SKILL_SILENT_SPELL, 500, 40, 1000000,
    CLASS_SORCERER | CLASS_CONJURER | CLASS_ILLUSIONIST |
 ...
 /* {EPIC_REWARD_SKILL, SKILL_TWOWEAPON, 100, 1, 1000000,
  ...
  {EPIC_REWARD_SKILL, SKILL_IMPROVED_TWOWEAPON, 1000, 1, 1000000,
    CLASS_WARRIOR | CLASS_MERCENARY | CLASS_ROGUE | CLASS_RANGER |
        CLASS_REAVER | CLASS_BERSERKER},*/
  {EPIC_REWARD_SKILL, SKILL_JIN_TOUCH, 100, 75, 1000000,
  CLASS_MONK},
  {EPIC_REWARD_SKILL, SKILL_KI_STRIKE, 100, 100, 1000000,
  CLASS_MONK},
  {EPIC_REWARD_SKILL, SKILL_INFUSE_LIFE, 100, 100, 1000000,
  CLASS_CONJURER | CLASS_NECROMANCER | CLASS_THEURGIST | 
    CLASS_SHAMAN},
  {EPIC_REWARD_SKILL, SKILL_SPELL_PENETRATION, 500, 200, 5000000,
...
/*  {EPIC_REWARD_SKILL, SKILL_IMPROVED_ENDURANCE, 100, 1, 500000,
    0 },*/
  {EPIC_REWARD_SKILL, SKILL_IMPROVED_TRACK, 100, 50, 1000000,
    CLASS_ROGUE | CLASS_MERCENARY | CLASS_RANGER},
  {EPIC_REWARD_SKILL, SKILL_EMPOWER_SONG, 100, 100, 500000,
    CLASS_BARD},
 /* {EPIC_REWARD_SKILL, SKILL_FIX, 100, 1, 100000,
  ...
  {EPIC_REWARD_SKILL, SKILL_SPELLBIND, 250, 100, 100000,
    0 },
  {EPIC_REWARD_SKILL, SKILL_SMELT, 100, 5, 10000,
    0 },
 /* {EPIC_REWARD_SKILL, SKILL_FORGE, 100, 1, 100000,
  ...
  {EPIC_REWARD_SKILL, SKILL_INDOMITABLE_RAGE, 100, 50, 500000,
 ...
 /* {EPIC_REWARD_SKILL, SKILL_NATURES_SANCTITY, 100, 1, 1000000,
  ...
  {EPIC_REWARD_SKILL, SKILL_EPIC_STRENGTH, 100, 50, 1000000,
    0 },
  {EPIC_REWARD_SKILL, SKILL_EPIC_POWER, 100, 50, 1000000,
    0 },
  {EPIC_REWARD_SKILL, SKILL_EPIC_AGILITY, 100, 50, 1000000,
    0 },
  {EPIC_REWARD_SKILL, SKILL_EPIC_INTELLIGENCE, 100, 50, 1000000,
    0 },
  {EPIC_REWARD_SKILL, SKILL_EPIC_DEXTERITY, 100, 50, 1000000,
    0 },
  {EPIC_REWARD_SKILL, SKILL_EPIC_WISDOM, 100, 50, 1000000,
    0 },
  {EPIC_REWARD_SKILL, SKILL_EPIC_CONSTITUTION, 100, 50, 1000000,
    0 },
  {EPIC_REWARD_SKILL, SKILL_EPIC_CHARISMA, 100, 50, 1000000,
    0 },
  {EPIC_REWARD_SKILL, SKILL_EPIC_LUCK, 100, 50, 1000000,
    0 },
